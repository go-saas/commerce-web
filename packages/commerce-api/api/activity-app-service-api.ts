...
/**
 * ActivityAppServiceApi - axios parameter creator
 * @export
 */
export const ActivityAppServiceApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        /**
         * 
         * @param {string} id 
...
/**
 * ActivityAppServiceApi - functional programming interface
 * @export
 */
export const ActivityAppServiceApiFp = function(configuration?: Configuration) {
    const localVarAxiosParamCreator = ActivityAppServiceApiAxiosParamCreator(configuration)
    return {
        /**
         * 
         * @param {string} id 
...
/**
 * ActivityAppServiceApi - factory interface
 * @export
 */
export const ActivityAppServiceApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    const localVarFp = ActivityAppServiceApiFp(configuration)
    return {
        /**
         * 
         * @param {ActivityAppServiceApiActivityAppServiceGetAppActivityRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        activityAppServiceGetAppActivity(requestParameters: ActivityAppServiceApiActivityAppServiceGetAppActivityRequest, options?: AxiosRequestConfig): AxiosPromise<V1Activity> {
            return localVarFp.activityAppServiceGetAppActivity(requestParameters.id, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @param {ActivityAppServiceApiActivityAppServiceListAppActivityRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        activityAppServiceListAppActivity(requestParameters: ActivityAppServiceApiActivityAppServiceListAppActivityRequest = {}, options?: AxiosRequestConfig): AxiosPromise<V1ListActivityReply> {
        ...
        /**
         * 
         * @param {ActivityAppServiceApiActivityAppServiceListAppActivity2Request} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        activityAppServiceListAppActivity2(requestParameters: ActivityAppServiceApiActivityAppServiceListAppActivity2Request, options?: AxiosRequestConfig): AxiosPromise<V1ListActivityReply> {
            return localVarFp.activityAppServiceListAppActivity2(requestParameters.body, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @param {ActivityAppServiceApiActivityAppServiceListAppActivityShowRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        activityAppServiceListAppActivityShow(requestParameters: ActivityAppServiceApiActivityAppServiceListAppActivityShowRequest, options?: AxiosRequestConfig): AxiosPromise<V1ListAppActivityShowReply> {
...
/**
 * Request parameters for activityAppServiceGetAppActivity operation in ActivityAppServiceApi.
 * @export
 * @interface ActivityAppServiceApiActivityAppServiceGetAppActivityRequest
 */
export interface ActivityAppServiceApiActivityAppServiceGetAppActivityRequest {
    /**
     * 
     * @type {string}
     * @memberof ActivityAppServiceApiActivityAppServiceGetAppActivity
     */
    readonly id: string
}

/**
 * Request parameters for activityAppServiceListAppActivity operation in ActivityAppServiceApi.
 * @export
 * @interface ActivityAppServiceApiActivityAppServiceListAppActivityRequest
 */
export interface ActivityAppServiceApiActivityAppServiceListAppActivityRequest {
    /**
     * 
     * @type {number}
     * @memberof ActivityAppServiceApiActivityAppServiceListAppActivity
     */
...
/**
 * Request parameters for activityAppServiceListAppActivity2 operation in ActivityAppServiceApi.
 * @export
 * @interface ActivityAppServiceApiActivityAppServiceListAppActivity2Request
 */
export interface ActivityAppServiceApiActivityAppServiceListAppActivity2Request {
    /**
     * 
     * @type {V1ListActivityRequest}
     * @memberof ActivityAppServiceApiActivityAppServiceListAppActivity2
     */
    readonly body: V1ListActivityRequest
}

/**
 * Request parameters for activityAppServiceListAppActivityShow operation in ActivityAppServiceApi.
 * @export
 * @interface ActivityAppServiceApiActivityAppServiceListAppActivityShowRequest
 */
export interface ActivityAppServiceApiActivityAppServiceListAppActivityShowRequest {
    /**
     * 
     * @type {string}
     * @memberof ActivityAppServiceApiActivityAppServiceListAppActivityShow
     */
    readonly id: string
}

/**
 * ActivityAppServiceApi - object-oriented interface
 * @export
 * @class ActivityAppServiceApi
 * @extends {BaseAPI}
 */
export class ActivityAppServiceApi extends BaseAPI {
    /**
     * 
     * @param {ActivityAppServiceApiActivityAppServiceGetAppActivityRequest} requestParameters Request parameters.
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     * @memberof ActivityAppServiceApi
     */
    public activityAppServiceGetAppActivity(requestParameters: ActivityAppServiceApiActivityAppServiceGetAppActivityRequest, options?: AxiosRequestConfig) {
        return ActivityAppServiceApiFp(this.configuration).activityAppServiceGetAppActivity(requestParameters.id, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof ActivityAppServiceApi
     */
    public activityAppServiceListAppActivity2(requestParameters: ActivityAppServiceApiActivityAppServiceListAppActivity2Request, options?: AxiosRequestConfig) {
        return ActivityAppServiceApiFp(this.configuration).activityAppServiceListAppActivity2(requestParameters.body, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof ActivityAppServiceApi
     */
    public activityAppServiceListAppActivityShow(requestParameters: ActivityAppServiceApiActivityAppServiceListAppActivityShowRequest, options?: AxiosRequestConfig) {
        return ActivityAppServiceApiFp(this.configuration).activityAppServiceListAppActivityShow(requestParameters.id, options).then((request) => request(this.axios, this.basePath));
    }
}
