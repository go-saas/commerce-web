...
export const ActivityServiceApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        activityServiceCreateActivity(requestParameters: ActivityServiceApiActivityServiceCreateActivityRequest, options?: AxiosRequestConfig): AxiosPromise<V1Activity> {
            return localVarFp.activityServiceCreateActivity(requestParameters.body, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         ...
         * @throws {RequiredError}
         */
        activityServiceDeleteActivity(requestParameters: ActivityServiceApiActivityServiceDeleteActivityRequest, options?: AxiosRequestConfig): AxiosPromise<V1DeleteActivityReply> {
            return localVarFp.activityServiceDeleteActivity(requestParameters.id, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         ...
         * @throws {RequiredError}
         */
        activityServiceGetActivity(requestParameters: ActivityServiceApiActivityServiceGetActivityRequest, options?: AxiosRequestConfig): AxiosPromise<V1Activity> {
            return localVarFp.activityServiceGetActivity(requestParameters.id, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         ...
         * @throws {RequiredError}
         */
        activityServiceUpdateActivity(requestParameters: ActivityServiceApiActivityServiceUpdateActivityRequest, options?: AxiosRequestConfig): AxiosPromise<V1Activity> {
            return localVarFp.activityServiceUpdateActivity(requestParameters.activityId, requestParameters.body, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         ...
         * @throws {RequiredError}
         */
        activityServiceUpdateActivity2(requestParameters: ActivityServiceApiActivityServiceUpdateActivity2Request, options?: AxiosRequestConfig): AxiosPromise<V1Activity> {
            return localVarFp.activityServiceUpdateActivity2(requestParameters.activityId, requestParameters.body, options).then((request) => request(axios, basePath));
        },
    };
};
